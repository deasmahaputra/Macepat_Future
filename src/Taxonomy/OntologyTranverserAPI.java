 ...
 * @author DEAS
 */
public class OntologyTranverserAPI{
    ...
    public  static ArrayList<String> lempar = new ArrayList<>();
     public  static ArrayList<String> lempar2 = new ArrayList<>();
...
//        lempar.add(
//                tampungan + "" + tampungan2 + "" + tampungan3 + "" + tampungan4 + "" +
...
//        for(int i = 0; i < lempar.size(); i++){
//            lempar2.add(lempar.get(i).replaceAll("\\s+", " "));
//        }
        System.out.println("Hasil Taxonomynya : " + lempar2);
        return fitur;
